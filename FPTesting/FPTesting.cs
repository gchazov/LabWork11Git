...
namespace MethodTesting
{
    ...
    public class FPTesting
    {
        ...
        {
            Queue<Animal> animals = new();
            Mammal m1 = new("кошка", 1, "поляна", true);
            Bird b1 = new("перепел", 3, "africa", true);
            Artiodactyl a1 = new("козлик", 19, "гора", true, "чёткие");
            //добавляем 
            animals.Enqueue(m1);
            animals.Enqueue(b1);
            animals.Enqueue(a1);
            Artiodactyl expected = new("козлик", 19, "гора", true, "чёткие");
        ...
        public void TestCloneQueue() //тест клонирования очереди
        {
            ...
            Bird b1 = new("перепел", 3, "кого он перепел?", true);
            Artiodactyl a1 = new("goat", 19, "гора", true, "cool");
            //добавляем 
            animals.Enqueue(m1);
            animals.Enqueue(b1);
            animals.Enqueue(a1);
